...
public class aimbot_blue extends LinearOpMode {
    ...
    public static double shottarget = -100;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            double omega = spin2.getVelocity();
            ...
            boolean inRev = gamepad2.dpad_left;
            ...
            if (far) {
                ...
                spin1.setPower(0.9);
                spin2.setPower(0.9);
                telemetry.addData("Far runs", shottarget);
                //sleep(10000000);
            }
            if (close) {
                shottarget = -48;
                ...
                spin2.setPower(0.75);
                telemetry.addData("Close runs", shottarget);
                //sleep(1000000000);
            ...
            //spin1.setPower(-powershot/1.3);
            //spin2.setPower(-powershot/1.3);
