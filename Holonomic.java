...
@Autonomous(name="Holonomic_blue")
public class Holonomic_Beta extends LinearOpMode {
    ...
    public static double px = -0.06, ix = 0.1, dx = 0.002;
    //0.03

    public static double targetx = 0;
    public static double py = -0.03, iy = 0.1, dy = 0.002;
    //0.03
...
//        limelight = hardwareMap.get(Limelight3A.class, "limelight");
        ...
        if (opModeIsActive()) {
            ...
            //clearing BUT ADD THIS AFTER
//            movebutnostop(70,125,0,1, false);
//
//            //clear the track
//
//
//            movebutnostop(70, 155, 0, 1, false);
//
//            movebutnostop(100, 155, 0, 1, false);




            //shoot set 2 of balls
            move(-20,165,0);

            //technicly set 1 of ball but who cares
            sleep(500);
            move(20,70,0);
...
//    void shoot(double last, boolean holdfasttrue) {
//        ElapsedTime sec = new ElapsedTime();
//
//
//        sec.reset();
...
//    }
    ...
    void move(double y, double x, double angle) {
        ElapsedTime sec = new ElapsedTime();
